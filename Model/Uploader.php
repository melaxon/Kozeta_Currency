...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'kozeta_currency/tmp/coin/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'kozeta_currency/coin/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'kozeta_currency/tmp/coin/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'kozeta_currency/coin/file';
