...
namespace Kozeta\Currency\Helper;
...
class Image extends AbstractHelper
{
     ...
     * Current model
     *
     * @var \Kozeta\Currency\Model\Image
     */
    protected $model;
     ...
     * image factory
     *
     * @var \Kozeta\Currency\Model\ImageFactory
     */
    ...
    public function init($entity, $imageId, $attributes = [])
    {
        ...
        $this->attributes = array_merge(
            $this->getConfigView()->getMediaAttributes('Kozeta_Currency', self::MEDIA_TYPE_CONFIG_NODE, $imageId),
            $attributes
        );
     ...
     *
     * @see \Kozeta\Currency\Model\Image
     * @param int $width
     * @param int $height
     * @return $this
     */
     ...
     *
     * @see \Kozeta\Currency\Model\Image\Image
     ...
     *
     * @return \Kozeta\Currency\Model\Image
     */
    protected function getModel()
    {
        if (!$this->model) {
            $this->model = $this->imageFactory->create(['entityCode' => 'coin']);
        }
        return $this->model;
    }
    ...
    public function getFrame()
    {
        ...
        if (empty($frame)) {
            $frame = $this->getConfigView()->getVarValue('Kozeta_Currency', 'image_white_borders');
        }
        return $frame;
    }
