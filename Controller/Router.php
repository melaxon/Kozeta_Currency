...
namespace Kozeta\Currency\Controller;
...
use Kozeta\Currency\Model\Routing\Entity;
...
class Router implements RouterInterface
{
    ...
    /**
     * Coin factory
     * @var \Kozeta\Currency\Model\CoinFactory
     */
    ...
    /**
     * @var \Kozeta\Currency\Model\Routing\Entity[]
     */
    ...
    /**
     * Validate and Match Currency Coin and modify request
     *
    ...
    public function match(RequestInterface $request)
    {
        if (!$this->dispatched) {
            ...
            $this->eventManager->dispatch(
                'kozeta_currency_controller_router_match_before',
    ...
    protected function matchRoute(RequestInterface $request, Entity $entity, $urlKey, $origUrlKey)
    {
        ...
        if ($listKey) {
            if ($urlKey == $listKey) {
                $request->setModuleName('currency');
